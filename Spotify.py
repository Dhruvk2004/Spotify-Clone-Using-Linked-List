...
def search_display():
    ...
    if obj==None:
        ...
        icon=CTkImage(Image.open("Images/musical_note.png"),size=(40,40))
...
def Update_cover():
    ...
    try:
        ...
        cover_photo = Image.open("Images/musical_note.png") 
...
main_f.pack()
photo=CTkImage(Image.open("Images/spotify.png"),size=(340,100))
l1=CTkLabel(main_f,image=photo,text=" ")
l1.place(relx=0.135,rely=0.08,anchor=CENTER)
photo=CTkImage(Image.open("Images/prev.png"),size=(60,60))
...
prev_b.place(relx=0.22,rely=0.94,anchor=CENTER)
play_img=CTkImage(Image.open("Images/play.png"),size=(60,60))
pause_img=CTkImage(Image.open("Images/pause.png"),size=(60,60))
...
play_but.place(relx=0.28,rely=0.94,anchor=CENTER)
photo=CTkImage(Image.open("Images/next.png"),size=(60,60))
...
next_b.place(relx=0.34,rely=0.94,anchor=CENTER)

#Player Cover
player_f=CTkFrame(window,width=500,height=500,corner_radius=40,border_color="#1DB954",border_width=15,bg_color="#191414")
player_f.place(relx=0.29,rely=0.52,anchor=CENTER)
cover_photo=CTkImage(Image.open("Images/Disk_cover.png"),size=(300,300))
...
sr_t.place(relx=0.69,rely=0.09,anchor=CENTER)
photo=CTkImage(Image.open("Images/search.png"),size=(50,50))
...
def playlist():
    photo=CTkImage(Image.open("Images/play_queue.png"),size=(60,60))
    ...
    b1.place(relx=0.52,rely=0.09,anchor=CENTER)
    list_f=CTkScrollableFrame(window,width=485,height=405,border_color="#1DB954",border_width=8,corner_radius=40,bg_color="#191414")
    list_f.place(relx=0.74,rely=0.51,anchor=CENTER)
    ...
    y_pad=0
    icon=CTkImage(Image.open("Images/musical_note.png"),size=(40,40))
    delete=CTkImage(Image.open("Images/delete.png"),size=(40,40))
...
def add_song():
    global select_lb
    add_f=CTkFrame(window,width=550,height=500,border_color="#1DB954",border_width=8,corner_radius=40,bg_color="#191414")
    add_f.place(relx=0.74,rely=0.51,anchor=CENTER)
...
add_b.place(relx=0.74,rely=0.93,anchor=CENTER)
